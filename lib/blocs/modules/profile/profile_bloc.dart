...
class ProfileBloc extends Bloc<ProfileEvent, ProfileState> {
  ...
  ProfileBloc({required this.context}) : super(ProfileInitial()) {
    on<ProfileEvent>((event, emit) {
      emit(ProfileLoading(
        ...
        questLineageLoading: state.questLineageLoading,
        questLineageError: state.questLineageError,
        questLineageUserJobId: state.questLineageUserJobId,
        questLineageTimezone: state.questLineageTimezone,
        questLineageScope: state.questLineageScope,
    ...
    on<ProfileLoadQuestLineageEvent>(_onProfileLoadQuestLineageEvent);
  ...
  FutureOr<void> _onProfileLoadEvent(ProfileLoadEvent event, Emitter<ProfileState> emit) async {
    ...
    add(ProfileLoadQuestLineageEvent(scope: QuestScope.all));
  }
  ...
  FutureOr<void> _onProfileLoadQuestLineageEvent(ProfileLoadQuestLineageEvent event, Emitter<ProfileState> emit) async {
    if (!authBloc.state.isAuthenticated) {
      return;
    }
    emit(ProfileLoading(
